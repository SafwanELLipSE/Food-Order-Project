  ...
  <body>
    ...
    <header id="header">
      <div class="container">
        <div class="row">
          <div class="col-md-10">
            <h1><span class="glyphicon glyphicon-cog" aria-hidden="true"></span> Reservation Detail Page<small>Manage Reservation Detail</small></h1>
          </div>
          <div class="col-md-2">
					...
					{					
							...
							"
							  <div class='row'>
								...
								<div class='col-md-6'>
									...
									<br>
									<br>
									<a class='btn btn-default btn-success' href='reservationli.php'>Back</a>
								</div>
							  </div>
							";
						}
						else
						{
							...
							"
							  <div class='row'>
								<div class='col-md-6'>
									<img src='images/download.png' class='img-rounded' style='width:250px; height:250px;'>
								</div>
								<div class='col-md-6'>
									<h3><strong>Name:</strong> No Info</h3>
									<h5>ID: No Info.</h5>
									<h5>Email: $res_email</h5>
									<h5>Password: No Info.</h5>
									<h5>Address: No Info.</h5>
									<h5>Country: No Info.</h5>
									<h5>City: No Info.</h5>
									<h5>Contact: No Info.</h5>
									<h5>Date: $res_date</</h5>
									<h5>Time: $res_time</</h5>
									<br>
									<br>
