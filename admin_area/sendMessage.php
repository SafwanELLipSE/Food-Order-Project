...
<html lang="en">
  <head>
    ...
    <title>Admin Area | Send Message</title>
              ...
              <div class="panel-body">
                <form action="" method="post" enctype="multipart/form-data">
				  ...
				  <div class="modal-footer">
					...
					<button type="submit" name="send" class="btn btn-primary"><i class="fas fa-envelope"></i> Send Mail</button>
				  </div>
                </form>
              </div>
              </div>
...
<?php 
	if(isset($_POST['send']))
	{
		...
		$to = "$email";
		$subject = "Message From FoodOrder.ini";
		$header = "From:message@FoodOrder.ini";
		$message = "$msg";
