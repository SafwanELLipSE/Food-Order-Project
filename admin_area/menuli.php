  ...
  <body>
    ...
    <header id="header">
      <div class="container">
        <div class="row">
          <div class="col-md-10">
            <h1><span class="glyphicon glyphicon-cog" aria-hidden="true"></span> Menu List<small>Manage Menu Items</small></h1>
          </div>
          <div class="col-md-2">
              ...
              <div class="panel-body">
				...
				?>
					...
					<table class="table table-striped table-hover">
                      ...
                      <tr>
                        <td><p style="margin-left:15px;"><?php echo $menu_id; ?></p></td>
                        <td><?php echo $menu_name; ?></td>
                        <td><input style="margin-left:40px;" type="checkbox" name="remove[]" value="<?php echo $menu_id;?>"/></td>
                        <td><a class="btn btn-default" href="editMenu.php?Menu_id=<?php echo $menu_id;?>">Edit</a> <button type="submit" class="btn btn-danger"  name="remove_menu">Delete</button></td>
                      </tr>
                    </table>
					</form>
				<?php
				...
				<?php 
					if(isset($_POST['remove_menu']))
					{
						foreach($_POST['remove'] as $remove_id)
						{
							...
							$delete_menu = "delete from menu where men_id = '$remove_id'";
