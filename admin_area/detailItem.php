...
<html lang="en">
  <head>
    ...
    <title>Admin Area | Item Detail</title>
			...
			<?php
				...
				<table class="table table-striped table-hover">
				  <div class="row">
					...
					<div class="col-md-6">
						<h3><strong>Name:</strong> <?php echo $pro_name;?></h3>
						...
						<a class="btn btn-default btn-success" href="editItem.php?product_id=<?php echo $pro_id;?>">Edit</a>
					</div>
				  </div>
				</table>
