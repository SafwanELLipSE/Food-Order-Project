  ...
  <body>
    ...
    <header id="header">
      <div class="container">
        <div class="row">
          <div class="col-md-10">
            <h1><span class="glyphicon glyphicon-cog" aria-hidden="true"></span> Order List<small>Manage rder Informations</small></h1>
          </div>
          <div class="col-md-2">
				...
				<?php 
					if(isset($_POST['cancel_order']))
					{
						foreach($_POST['remove'] as $remove_id)
						{
							...
							if($run_delete)
							{
								echo "<script>alert('Order has been canceled From the List!')</script>";
