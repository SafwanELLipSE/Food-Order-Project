...
<html lang="en">
  <head>
    ...
    <title>Admin Area | Contact List</title>
  ...
  <body>
      ...
      <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
            ...
            <li class="active"><a href="contactli.php">Contact List</a></li>
          </ul>
    ...
    <header id="header">
      <div class="container">
        <div class="row">
          <div class="col-md-10">
            <h1><span class="glyphicon glyphicon-cog" aria-hidden="true"></span> Contact List<small>Manage Contact Informations</small></h1>
          </div>
          <div class="col-md-2">
            ...
            <div class="panel panel-default">
              ...
              <div class="panel-body">
					...
					while($row_con=mysqli_fetch_array($run_con))
						{
							...
							$con_name = $row_con['contact_name'];
							$con_email = $row_con['contact_Email'];
							$con_message = $row_con['contact_message'];
                ...
                <table class="table table-striped table-hover">
                    ...
                    <tr>
                        <td><h5><b>ID:</b> <?php echo $con_id;?></</h5></td>
                        <td>
							<h5><b>Email:<br></b> <?php echo $con_email;?></</h5>
						</td>
                        <td><input style="margin-left:40px; margin-top:40px;" type="checkbox" name="remove[]" value="<?php echo $con_id;?>"/></td>
                        <td><a style= "margin-top:35px;" class="btn btn-default" href="detailContact.php?contact_id=<?php echo $con_id;?>">Detail</a> <button type="submit" style= "margin-top:35px;" class="btn btn-danger" name="remove_contact">Delete</button></td>
                    </tr>
				</table>
				</form>
				...
				<?php 
					if(isset($_POST['remove_contact']))
					{
						...
						{
							$delete_contact = "delete from contact where contact_id = '$remove_id'";
							$run_delete = mysqli_query($con, $delete_contact); 
							
							if($run_delete)
							{
								echo "<script>alert('Contact has been deleted!')</script>";
								echo "<script>window.open('contactli.php','_self')</script>";
							}
						}
