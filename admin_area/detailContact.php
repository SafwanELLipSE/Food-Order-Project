              ...
              <div class="panel-body">
				<?php
					...
					{					
						...
						$get_con = "select * from contact where contact_id ='$contact_id'";
				...
				<table class="table table-striped table-hover">
					<div class="container">
						<div class="row">
							...
							<div class="col-md-6">
								<h3><strong>Name:</strong> <?php echo $con_name;?></h3>
								<h5>ID: <?php echo $con_id;?></h5>
								<h5>Email: <?php echo $con_email;?></h5>
								<h5>Message: <?php echo $con_message;?></h5>
								<a class="btn btn-default btn-success" href="contactli.php?contact_id=<?php echo $con_id;?>">Back</a>
							</div>
						</div>
					</div>
				</table>
