  ...
  <body>
      ...
      <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
            ...
            <li class="active"><a href="categoryli.php">Category List</a></li>
    ...
    <header id="header">
      <div class="container">
        <div class="row">
          <div class="col-md-10">
            <h1><span class="glyphicon glyphicon-cog" aria-hidden="true"></span> Category List<small>Manage Category Items</small></h1>
          </div>
          <div class="col-md-2">
            ...
            <div class="panel panel-default">
              ...
              <div class="panel-body">
                ...
                <table class="table table-striped table-hover">                     
                      ...
                      <tr>
                        <td><p style="margin-left:15px;"><?php echo $cat_id; ?></p></td>
                        <td><?php echo $cat_name; ?></td>
                        <td><input style="margin-left:40px;" type="checkbox" name="remove[]" value="<?php echo $cat_id;?>"/></td>
                        <td><a class="btn btn-default" href="editCategory.php?Category_id=<?php echo $cat_id;?>">Edit</a> <button type="submit" class="btn btn-danger" name="remove_category">Delete</button></td>
                      </tr>
                 </table>
				 </form>
				...
				<?php 
					if(isset($_POST['remove_category']))
					{
						foreach($_POST['remove'] as $remove_id)
						{
							...
							$delete_menu = "delete from category where cat_id = '$remove_id'";
							$run_delete = mysqli_query($con, $delete_menu); 
